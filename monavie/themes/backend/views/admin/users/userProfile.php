...
<div class="row-fluid">
    <div class="span12">
        <div class="span4">
            ...
            <?php else: ?>
                <img data-src="holder.js/260x180" src="<?php echo $baseUrl; ?>/images/members/<?php echo $model->image_profile; ?>" alt="" class="thumbnail"/>
            <?php endif; ?>
        </div><!-- Image -->
        <div class="span8">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $form->passwordField($model, 'password', array('readonly' => true)); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $form->textField($model, 'lastname', array('readonly' => true)); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $form->textArea($model, 'address', array('readonly' => true)); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $form->textField($model, 'tel', array('readonly' => true)); ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $form->textField($model, 'mobile', array('readonly' => true)); ?>
