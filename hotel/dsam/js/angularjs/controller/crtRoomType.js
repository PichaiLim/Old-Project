...
app.controller('RoomTypeController', function($scope, RoomTypeService, $location, $http, $routeParams){
    ...
    $scope.RoomTypeDataList = function(){
        ...
        RoomTypeService.getRoomTypeList(branch_id).then(function(data){
    ...
    $scope.btnAdd = function(){
        ...
        RoomTypeService.getBranchViewByPk($routeParams.id).then(function(data){
            ...
            .then(function(data){
                ...
                /*angular.forEach(data, function(item, value){
                    ...
                    if(item == false){
                        ...
                        $scope.msg = "กรุณากรอกข้อมูลให้ถูกต้อง";
    ...
    $scope.confirmDelete = function(id){
        RoomTypeService.getRoomTypeDelete(id);
        window.location.reload(false);
    };
    ...
    $scope.validateForm = function(form){
        console.log(form.$invalid+' '+$scope.chk_name());
