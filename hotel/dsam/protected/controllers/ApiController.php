...
//            'index'=>'application.controllers.api.IndexAction',
    ...
    public function actionList()
    {
        ...
        switch($_GET['model'])
        {
            ...
            /*case 'inventory':
                $crtInventory = new CDbCriteria;
                $crtInventory->select = 't.*, p.*';
                $crtInventory->join = 'INNER JOIN product p ON p.id = t.product_id';
//                $crtInventory->join .= 'INNER JOIN branch b ON b.id = t.branch_id';

                $models = Inventory::model()->findAll($crtInventory);
                break;*/
