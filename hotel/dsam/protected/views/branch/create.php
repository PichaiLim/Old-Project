...
<form class="form-horizontal"
      ...
      action="#"
      autocomplete="off"
      ng-controller="BranchController as b">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="province_id" id="province_id"
                                        required
                                        ng-options="Province.province for Province in b.listDataProvince"
                                        ng-model="b.province_id"
                                        ng-change="b.setDataListDistrict(b.province_id)">
                                </select >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="district_id" id="district_id"
                                        required
                                        ng-model="b.district_id"
                                        ng-change="b.setDataListArea(b.district_id);"
                                        ng-options="District.district for District in b.listDataDistrict">
                                </select >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="area_id" id="area_id"
                                        required
                                    ng-model="b.area_id"
                                    ng-change="b.setDataListPostalCode(b.area_id);"
                                    ng-options="Area.area for Area in b.listDataArea">
                                </select >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="postal_code" id="postal_code"
                                    ...
                                    ng-options="PostalCode.postal_code for PostalCode in b.listDataPostalCode track
                                    by b.postal_code">
                                </select >
                            ...
                            <div class="col-sm-9">
                                <label for="active" class="radio-inline"
                                    ...
                                    <input type="radio" name="active" id="active"
                                           ng-value="Active.value" ng-model="b.active"
    ...
    <div class="modal-footer bg-info">
        ...
        <button type="button" class="btn btn-primary" ng-click="b.btnConfirmCreate()"
