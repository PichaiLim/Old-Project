...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('employee_type_id')); ?>:</b>
	<?php echo CHtml::encode($data->employee_type_id); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('login_timeout')); ?>:</b>
	<?php echo CHtml::encode($data->login_timeout); ?>
	<br />
