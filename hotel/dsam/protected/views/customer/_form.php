<div class="row bootbox-body">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" target="_top">ข้อมูลส่วนตัว</a></li>
        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" target="_top" target="_top">ที่อยู่อาศัย</a></li>
        <li role="presentation"><a href="#remark" aria-controls="remark" role="tab" data-toggle="tab" target="_top" target="_top">หมายเหตุ</a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="profile">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="district_id" id="district_id" ng-model="c.district_id"
                            ng-change="c.changeDistrict(c.district_id);">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="postal_code" id="postal_code" ng-model="postal_code">
                        <option ng-repeat="PC in c.listPostalCode" value="{{PC.postal_code}}"
                            ng-selected="c.postal_code == PC.area_id">
                            {{PC.postal_code}}
                        </option >
