<?php
/* @var $this InventoryPushController */
?>

<div ng-controller="InventoryPushController as i" id="branch_id" data-val="<?php echo $_GET['id']; ?>">
     <div class="container-fluid">
         <div class="row">
             <div class="col-xs-8">
                 <a href="#/Inventorypush/create"
                    ...
                    <div class="panel-body panel-no-padding">
                        <table id="example"
                            ...
                            <tr role="row">
                                ...
                                <th class="text-center sorting" ng-click="i.sort(quantity);" >ราคาต่อหน่วย</th >
                                <th class="text-center sorting" ng-click="i.sort(pushed);" >จำนวน</th >
                                <th class="text-center sorting" ng-click="i.sort(pushed);" >ราคารวม</th >
