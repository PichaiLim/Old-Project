                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body panel-no-padding">
                        <table id="example" class="table table-condensed table-bordered table-hover dataTable no-footer" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <tr dir-paginate="list in b.buildingList | orderBy:b.sortKey:b.reverse | filter:search| itemsPerPage:5">
                                <td >
                                    {{list.name}}
                                </td >
                                ...
                                <td class="col-xs-1">
                                    <div class="btn-group btn-group-justified">
                                        <a href="#/building/update/{{list.id}}"
                                           class="btn btn-default item-edit-btn"
                                           data-id=""
                                           data-toggle="modal"
                                           data-target="#modal-fullscreen"
                                            ng-click="b.btnUpdate(list.id, list.name)">
                                        ...
                                        <a href="#"
                                           ...
                                           data-toggle="modal" data-target="#delete"
                                            ng-click="b.btnDelete(list.id, list.name);">
                ...
                <div class="modal-body">
                    <div class="bootbox-body">
                        <p>
                            ...
                            <b>อาคาร{{b.name}} สาขา <?php echo @$_SESSION['branch']; ?></b>
                        </p>
                        <p class="">
                            คุณแน่ใจแล้ว
