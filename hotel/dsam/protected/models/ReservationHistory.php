...
class ReservationHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, branch_id, building_id, floor_id, room_id, customer_id, created, created_by, updated_by, status, start, end, num_days, price, amount', 'required'),
			array('id, branch_id, building_id, floor_id, room_id, customer_id, created_by, updated_by, payee, num_days, price, deposit, amount', 'length', 'max'=>10),
			array('reciept_no', 'length', 'max'=>16),
			array('status', 'length', 'max'=>9),
			array('updated, paid', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, reciept_no, branch_id, building_id, floor_id, room_id, customer_id, created, created_by, updated, updated_by, status, paid, payee, start, end, num_days, price, deposit, amount', 'safe', 'on'=>'search'),
		);
	}
