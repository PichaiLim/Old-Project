...
class InventoryPull extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('branch_id, product_id, created, created_by, quantity', 'required'),
			array('branch_id, product_id, created_by, quantity', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, branch_id, product_id, created, created_by, quantity', 'safe', 'on'=>'search'),
		);
	}
