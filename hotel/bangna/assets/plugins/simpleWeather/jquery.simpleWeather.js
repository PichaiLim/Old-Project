        ...
        function(data) {
          if(data && data.query && data.query.results && data.query.results.channel.description !== 'Yahoo! Weather Error') {
            ...
            options.error({message: "There was an error retrieving the latest weather information. Please try again."
              , error: (data && data.query && data.query.results && data.query.results.channel && data.query.results.channel.item && data.query.results.channel.item.title)?data.query.results.channel.item.title:''});
          }
        }
      );
      return this;
