 ...
 * <ul>
 * <li>The first rule says that if the user requests the URL '/path/to/_index.php/articles',
 *   it should be treated as '/path/to/_index.php/article/list'; and vice versa applies
 ...
 *   '/path/to/_index.php/article/13', it should be treated as '/path/to/_index.php/article/read?id=13';
 ...
 * For example, using the rules above, the URL '/_index.php/post/123/create'
