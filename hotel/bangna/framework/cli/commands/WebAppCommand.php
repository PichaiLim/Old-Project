...
EOD;
	...
	{
		$fileList['_index.php']['callback']=array($this,'generateIndex');
	...
	/**
	 * Inserts path to framework's yii.php into application's _index.php
	 *
	...
	public function generateIndex($source,$params)
	{
		...
		$yii=$this->getRelativePath($yii,$this->_rootPath.DIRECTORY_SEPARATOR.'_index.php');
		$yii=str_replace('\\','\\\\',$yii);
