 ...
 * to return to the backend_homepage.
 *
...
class CBreadcrumbs extends CWidget
{
	 ...
	 *
	 * The following example will generate breadcrumbs as "Home > Sample post > Edit", where "Home" points to the backend_homepage,
	 * "Sample post" points to the "_index.php?r=post/view&id=12" page, and "Edit" is a label. Note that the "Home" link
