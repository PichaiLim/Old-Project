...
class Reservation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('branch_id, building_id, floor_id, room_id, customer_id, created_by, updated_by, payee, num_days, price, deposit,used_deposit_old, deposit_with_me, amount', 'length', 'max'=>10),
			array('status', 'length', 'max'=>9),
			array('paid_status,paid_deposit', 'length', 'max'=>3),
			array('updated, paid', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, reciept_no, branch_id, building_id, floor_id, room_id, customer_id, created, created_by, updated, updated_by, status, paid_status, paid, payee, start, end, num_days, price, deposit, used_deposit_old, deposit_with_me, amount, paid_deposit, description', 'safe', 'on'=>'search'),
		);
	}
