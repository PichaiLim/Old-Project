...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <a class="shortcut-tiles tiles-magenta"
       href="<?php echo Yii::app()->createUrl('/Reservation/View',array('id'=>$_GET['id'])); ?>">
        ...
        <div class="tiles-footer">
            <span class="pull-right">ข้อมูลการเช็คเอ้าท์ห้องพัก</span>
        </div>
    </a>
</div>
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <a class="shortcut-tiles tiles-magenta" href="<?php echo Yii::app()->createUrl('/Reservation/Payment', array
    ('id'=>$_GET['id']));
    ?>">
        <div class="tiles-body">
        ...
        <div class="tiles-footer">
            <span class="pull-right">ข้อมูลยืนยันชำระเงิน</span>
        </div>
    </a>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <a class="shortcut-tiles tiles-primary"
       href="<?php echo Yii::app()->createUrl('/Customer/index', array('id'=>$_GET['id']));?>">
        <div class="tiles-body">
            <div class="pull-left"><i class="fa fa-fw fa-users"></i></div>
        </div>
        <div class="tiles-footer">
            <span class="pull-right">ข้อมูลการลูกค้า</span>
        </div>
    </a>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <a class="shortcut-tiles tiles-magenta"
       href="<?php echo Yii::app()->createUrl('/Report/Daily', array('id'=>$_GET['id'])); ?>">
        <div class="tiles-body">
            <div class="pull-left"><i class="fa fa-fw fa-flag"></i></div>
        </div>
        <div class="tiles-footer">
            <span class="pull-right">รายงานการเข้าพักรายวัน</span>
        </div>
    </a>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
    <a class="shortcut-tiles tiles-info"
       href="<?php echo Yii::app()->createUrl('/Report/SummaryDaily', array('id'=>$_GET['id'])); ?>">
        <div class="tiles-body">
            <div class="pull-left"><i class="fa fa-fw fa-flag"></i></div>
        </div>
        <div class="tiles-footer">
            <span class="pull-right">รายงานสรุปการเข้าพักรายวัน</span>
        </div>
    </a>
</div>
