...
<div ng-controller="InventoryController as i" id="branch_id" data-val="<?php echo $_GET['id']; ?>" ng-init="i.init(1)">
     <div class="container-fluid">
         <div class="row">
             <div class="col-xs-8">
                 <a class="btn btn-default mt0 width-64px"
                    ng-click="i.addInventoryPullOrPushListModal(1);">
            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2>การนำเข้าวัสดุสิ้นเปลือง</h2>
                    ...
                    <div class="panel-body panel-no-padding">
                        <table id="example"
                            ...
                            <thead>
                            <tr role="row">
                                <th class="text-center sorting" ng-click="i.sort(reciept_no);" >หมายเลขบิล</th >
                            ...
                            <tbody>
                            <tr dir-paginate="I in i.InventoryPushDataList | orderBy: i.sortKey:i.reverse | filter: search |
                                itemsPerPage: 10" >
                                <td align="center" ng-click="i.displayInventoryPush(I.reciept_no, 1)" style="cursor: pointer;">
                                    {{I.reciept_no}}
                                </td >
                                <td align="center" ng-click="i.displayInventoryPush(I.reciept_no, 1)" style="cursor: pointer;">
                                    {{I.created_by}}
                                </td >
                                <td align="center" ng-click="i.displayInventoryPush(I.reciept_no, 1)" style="cursor: pointer;">{{I.created}}
                                </td >
                            </tr >
                            </tbody>
                        </table>
      ...
      <div class="modal-footer">
          <div class="col-sm-6" align="left">
              ...
              <input class="form-control"
                           type="text"
                           ng-model="billNumber"
                           ng-blur="changeBillNumber(billNumber)"
                           ng-keyup="changeBillNumber(billNumber)"/>
              <span class="text-danger" >{{errorBillNumber}}</span >
          </div>
          <div class="col-sm-6" align="right">
            <button class="btn btn-primary" type="button" ng-disabled="errorBillNumber" ng-click="ok(<?php echo Yii::app()->user->id;?>)">OK</button>
...
<script type="text/ng-template" id="addInventoryDetailModalContent.html">
    <div ng-init="init()">
      <div class="modal-header">
        <h3 class="modal-title">
            <i class="fa fa-fw fa-plus"></i>เพิ่มวัสดุสิ้นเปลือง
        </h3>
      </div>
      <div class="modal-body">
        <form class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="number"
                               ...
                               min="1"
                               required
                               ng-blur="quantityOnBlur(1)"
                               ng-keyup="quantityOnBlur(1)"
