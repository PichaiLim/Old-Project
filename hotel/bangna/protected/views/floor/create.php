...
<form action="#"
    ...
    <div class="modal-content">
            ...
            <div class="row bootbox-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active">
                        <a href="#/floor/create#tabPane0" role="tab" data-toggle="tab" aria-expanded="true">
                            <i class="fa fa-fw fa-archive"></i>
                            ข้อมูลชั้น
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="#/floor/create#tabPane1" role="tab" data-toggle="tab">
                            SEO
                        </a>
                    </li>
                </ul>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <select name="building_id"
                                    ...
                                    <option value="" ></option >
                                    <option ng-repeat="listBuilding in f.buildingForTheBuildingList"
        ...
        <div class="modal-footer bg-info">
            ...
            <button type="button" class="btn btn-primary" ng-click="f.SaveCreate()">
                <span class="fa fa-fw fa-check"></span>
                บันทึก
            </button>
