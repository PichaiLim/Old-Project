                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tabPane0" role="tabepanel">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <textarea name="remark" ng-model="b.remark" id="remark" class="form-control" cols="30" rows="3"></textarea >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="radio-inline">
                                            <input type="radio" name="active" id="active" ng-model="b.active" value="1">Yes
                                        </label>

                                        <label class="radio-inline">
                                            <input type="radio" name="active" id="active" ng-model="b.active" value="">No
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="radio-inline">
                                            <input type="radio" name="published" id="published" ng-model="b.published" value="1">Yes
                                        </label>

                                        <label class="radio-inline">
                                            <input type="radio" name="published" id="published" ng-model="b.published" value="">No
                                        </label>
                                    </div>
                                </div>
