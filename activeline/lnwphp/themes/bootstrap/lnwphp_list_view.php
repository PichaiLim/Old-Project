...
<?php } ?>
        <div class="lnwphp-list-container">
        <table class="lnwphp-list table table-striped table-hover table-bordered">
            <thead>
        ...
        <?php echo $this->render_control_fields(); ?>
        <div class="lnwphp-nav">
