<div class="row pageshowmenu">
    ...
    <div class="col-md-9">
        <?php $news_show = $lnwphp->table_array('lp_portfolio', "`id` = '" . $idpage . "'"); ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="fotorama" data-allowfullscreen="true" data-loop="true" data-autoplay="true"
                     data-transition="slide" data-clicktransition="crossfade" data-nav="thumbs" data-width="100%"
                     data-height="200">
                    <?php if ($news_show->gallery_1 != '') {
